    ...
    module Definitions
      module PST8PDT
        ...
        timezone 'PST8PDT' do |tz|
          ...
          tz.transition 1942, 2, :o1, -880207200, 29164799, 12
          ...
          tz.transition 2075, 3, :o1, 3319437600, 29748083, 12
          tz.transition 2075, 11, :o0, 3339997200, 19833959, 8
          tz.transition 2076, 3, :o1, 3350887200, 29752451, 12
          tz.transition 2076, 11, :o0, 3371446800, 19836871, 8
        end
      end
    end
  end
