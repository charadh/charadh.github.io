    ...
    module Definitions
      module MST7MDT
        ...
        timezone 'MST7MDT' do |tz|
          ...
          tz.transition 1942, 2, :o1, -880210800, 19443199, 8
          ...
          tz.transition 2075, 3, :o1, 3319434000, 19832055, 8
          tz.transition 2075, 11, :o0, 3339993600, 14875469, 6
          tz.transition 2076, 3, :o1, 3350883600, 19834967, 8
          tz.transition 2076, 11, :o0, 3371443200, 14877653, 6
        end
      end
    end
  end
